@echo off
title OOP Notes Server
echo ===================================================
echo   OOP Notes Startup and Management Service
echo ===================================================
echo.

:: 1. Clean port 8123
echo [1/4] Checking and cleaning port 8123...
set found=0
...
if %found%==1 (
    echo      Successfully terminated conflicting process on port 8123.
) else (
    echo      Port 8123 is clean and free.
)
...
echo      -------------------------------------------------
echo.
python -m mkdocs serve -a 127.0.0.1:8123
